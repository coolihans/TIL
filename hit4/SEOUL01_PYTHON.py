...
while True:
    ...
    for i in range(1, NUMBER_OF_BALLS+1,2):
    ...
    # foulball1, 2
    foulball1_x = balls[2][0]
    foulball1_y = balls[2][1]
    foulball2_x = balls[4][0]
    foulball2_y = balls[4][1]
    f1_width = abs(foulball1_x - whiteBall_x)
    f1_height = abs(foulball1_y - whiteBall_y)
    f2_width = abs(foulball2_x - whiteBall_x)
    f2_height = abs(foulball2_y - whiteBall_y)
    ...
    # for hole in HOLES:
    #     x = abs(hole[0] - targetBall_x)
    #     y = abs(hole[1] - targetBall_y)
    #     hole_distance = math.sqrt(x**2 + y**2)
